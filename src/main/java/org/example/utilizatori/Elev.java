...
public class Elev extends Utilizator {
    ...
    private Queue<Cerere> cereriElev;


    public Elev(String nume, String scoala) {
        this.nume = nume;
        this.scoala = scoala;
        this.cereriElev = new PriorityQueue<>(new Comparator<Cerere>(){
            @Override
    ...
    public String scriereCerere(Cerere.TipCerere tip) {
        ...
        return "Subsemnatul " + this.nume + ", elev la scoala " + this.scoala + ", va rog sa-mi aprobati urmatoarea solicitare: " + tipul;
    }
    ...
    public Cerere creeazaCerere(Cerere.TipCerere tip, int prioritate, String data, PrintWriter printWriter) throws IOException {
        ...
        try {
            switch(tip) {
                ...
                default: {
                    throw new UtilizatorCerereNepermisa("Utilizatorul de tip elev nu poate inainta o cerere de tip " + tipul);
                }
            }
        } catch (Exception e) {
    ...
    public void retrageCerere(Date data) {
        Iterator<Cerere> iterator = cereriElev.iterator();
    ...
    public void afisareCereriInAsteptare(PrintWriter printWriter) {
        ...
        Queue<Cerere> cereriElevCopie = new PriorityQueue<>(cereriElev);
