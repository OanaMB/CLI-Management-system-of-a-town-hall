...
public class Pensionar extends Utilizator {
    private String nume;
    private Queue<Cerere> cereriPensionar;

    public Pensionar(String nume) {
        this.nume = nume;
        this.cereriPensionar = new PriorityQueue<>(new Comparator<Cerere>(){
            @Override
    ...
    public Cerere creeazaCerere(Cerere.TipCerere tip, int prioritate, String data, PrintWriter printWriter) throws IOException {
        ...
        try {
            switch(tip) {
                ...
                default: {
                    throw new UtilizatorCerereNepermisa("Utilizatorul de tip pensionar nu poate inainta o cerere de tip " + tipul);
                }
            }
        } catch (Exception e) {
        ...
        this.cereriPensionar.add(cerere);
        return cerere;
    }
    ...
    public void retrageCerere(Date data) {
        Iterator<Cerere> iterator = cereriPensionar.iterator();
    ...
    public void afisareCereriInAsteptare(PrintWriter printWriter) {
        ...
        Queue<Cerere> cereriElevCopie = new PriorityQueue<>(cereriPensionar);
