...
public class EntitateJuridica extends Utilizator {
    ...
    private Queue<Cerere> cereriEntitateJuridica;


    public EntitateJuridica(String nume, String reprezentant) {
        this.nume = nume;
        this.reprezentant = reprezentant;
        this.cereriEntitateJuridica = new PriorityQueue<>(new Comparator<Cerere>(){
            @Override
    ...
    public String scriereCerere(Cerere.TipCerere tip) {
        ...
        return "Subsemnatul " + this.reprezentant + ", reprezentant legal al companiei " + this.nume + ", va rog sa-mi aprobati urmatoarea solicitare: " + tipul;
    }
    ...
    public Cerere creeazaCerere(Cerere.TipCerere tip, int prioritate, String data, PrintWriter printWriter) throws IOException {
        ...
        try {
            switch(tip) {
                ...
                default: {
                    throw new UtilizatorCerereNepermisa("Utilizatorul de tip entitate juridica nu poate inainta o cerere de tip " + tipul);
                }
            }
        } catch (Exception e) {
        ...
        this.cereriEntitateJuridica.add(cerere);
        return cerere;
    }
    ...
    public void retrageCerere(Date data) {
        Iterator<Cerere> iterator = cereriEntitateJuridica.iterator();
    ...
    public void afisareCereriInAsteptare(PrintWriter printWriter) {
        ...
        Queue<Cerere> cereriElevCopie = new PriorityQueue<>(cereriEntitateJuridica);
